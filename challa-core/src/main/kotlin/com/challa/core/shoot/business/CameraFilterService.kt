...
@Service
class CameraFilterService(private val cameraFiltersStorage: CameraFiltersStorage) : CameraFilterUseCase {

    override fun getAll(): GetCameraFiltersResult =
        GetCameraFiltersResult(cameraFilters = cameraFiltersStorage.getAll())
}
